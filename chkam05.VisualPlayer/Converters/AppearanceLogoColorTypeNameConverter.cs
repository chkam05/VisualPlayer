...
{
    public class AppearanceLogoColorTypeNameConverter : IValueConverter
    {

        //  CONST

        private static readonly Dictionary<AppearanceLogoColorType, string> _mapping = new Dictionary<AppearanceLogoColorType, string>
        {
            { AppearanceLogoColorType.APPLICATION, "Application Color" },
            { AppearanceLogoColorType.DARK, "Dark" },
            { AppearanceLogoColorType.LIGHT, "Light" },
        };
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                var enumValue = (AppearanceLogoColorType)value;
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return AppearanceLogoColorType.DARK;
        }
    }
}
