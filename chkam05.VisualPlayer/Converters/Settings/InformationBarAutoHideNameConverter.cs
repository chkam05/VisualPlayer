...
{
    public class InformationBarAutoHideNameConverter : IValueConverter
    {
        ...
        private static readonly Dictionary<InformationBarAutoHide, string> _mapping =
            new Dictionary<InformationBarAutoHide, string>
            {
                ...
                { InformationBarAutoHide.STAY_3S, "Hide after 3 sec." },
                { InformationBarAutoHide.STAY_5S, "Hide after 5 sec." },
                { InformationBarAutoHide.STAY_10S, "Hide after 10 sec." },
