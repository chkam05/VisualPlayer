...
{
    public class AppearanceLogoThemeNameConverter : IValueConverter
    {

        //  CONST

        private static readonly Dictionary<AppearanceLogoTheme, string> _mapping = new Dictionary<AppearanceLogoTheme, string>
        {
            { AppearanceLogoTheme.ACCENT_COLOR, "Accent Color Theme" },
            { AppearanceLogoTheme.DARK, "Dark Theme" },
            { AppearanceLogoTheme.LIGHT, "Light Theme" }
        };
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                var enumValue = (AppearanceLogoTheme)value;
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return AppearanceLogoTheme.ACCENT_COLOR;
        }
