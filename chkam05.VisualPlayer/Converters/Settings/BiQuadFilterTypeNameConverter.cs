...
{
    public class BiQuadFilterTypeNameConverter : IValueConverter
    {

        //  CONST

        private static readonly Dictionary<BiQuadFilterType, string> _mapping = new Dictionary<BiQuadFilterType, string>
        {
            { BiQuadFilterType.None, "No filter" },
            { BiQuadFilterType.BandpassFilter, "Bandpass filter" },
            { BiQuadFilterType.HighpassFilter, "Highpass filter" },
            { BiQuadFilterType.HighShelfFilter, "High Shelf filter" },
            { BiQuadFilterType.LowpassFilter, "Lowpass filter" },
            { BiQuadFilterType.LowShelfFilter, "Low Shelf filter" },
            { BiQuadFilterType.NotchFilter, "Notch filter" },
            { BiQuadFilterType.PeakFilter, "Peak filter" },
        };
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                var enumValue = (BiQuadFilterType)value;
