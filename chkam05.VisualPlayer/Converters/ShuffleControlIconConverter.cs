...
{
    public class ShuffleControlIconConverter : IValueConverter
    {
        ...
        {
            var shuffle = (bool)value;

            return shuffle ? PackIconKind.Shuffle : PackIconKind.ShuffleDisabled;
        }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (packIconKind)
            {
                ...
                case PackIconKind.ShuffleDisabled:
                default:
                    return false;
            }
        }
