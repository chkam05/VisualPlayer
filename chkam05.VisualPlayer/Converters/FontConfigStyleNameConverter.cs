...
{
    public class FontConfigStyleNameConverter : IValueConverter
    {

        //  CONST

        private static readonly Dictionary<FontConfigStyle, string> _mapping = new Dictionary<FontConfigStyle, string>
        {
            { FontConfigStyle.Standard, "Standard" },
            { FontConfigStyle.Electronic, "Electronic" },
            { FontConfigStyle.ElectronicOld, "Electronic Old" },
            { FontConfigStyle.Custom, "Custom" },
        };
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                var enumValue = (FontConfigStyle)value;
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return FontConfigStyle.Standard;
        }
    }
}
