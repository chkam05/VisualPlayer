...
namespace chkam05.VisualPlayer.Converters.Settings
{
    public class AppearanceThemeTypeNameConverter : IValueConverter
    {
        ...
        private static readonly Dictionary<AppearanceThemeType, string> _mapping = new Dictionary<AppearanceThemeType, string>
        {
            { AppearanceThemeType.ACCENT_COLOR, "Accent Color Theme" },
            { AppearanceThemeType.DARK, "Dark Theme" },
            { AppearanceThemeType.LIGHT, "Light Theme" },
            { AppearanceThemeType.SYSTEM, "System Theme" },
            { AppearanceThemeType.USER, "Custom Theme" }
        };
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value != null)
            {
                var enumValue = (AppearanceThemeType)value;
