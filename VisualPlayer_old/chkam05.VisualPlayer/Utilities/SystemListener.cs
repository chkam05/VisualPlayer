...
namespace chkam05.VisualPlayer.Utilities
{
    public class SystemListener
    {
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the user changes the display settings. </summary>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the display settings are changing. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked before the thread that listens for system events is terminated. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the user adds fonts to or removes fonts from the system. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the user switches to an application that uses a different palette. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the user suspends or resumes the system. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the user is logging off or shutting down the system. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the user is trying to log off or shut down the system. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the currently logged-in user has changed. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when the user changes the time on the system clock. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when a windows timer interval has expired. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Method invoked when a user preference is changing. </summary>
        /// <param name="sender"> Object that dispatched event. </param>
        /// <param name="e"> Event Arguments. </param>
